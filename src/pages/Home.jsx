    ...
    return(
        <>
            ...
            <div class="overflow-x-hidden px-4" id="carousel">
                ...
                <a href="./details.html" class="px-4 relative card group">
                    <div
                    ...
                    <img
                        src="../assets/images/content/image-arrived-1.png"
                        alt=""
                ...
                <div class="px-4 relative card group">
                    ...
                    <img
                        src="../assets/images/content/image-arrived-2.png"
                        alt=""
                        class="w-full h-full object-cover object-center"
                    />
                    </div>
                ...
                <div class="px-4 relative card group">
                    ...
                    <img
                        src="../assets/images/content/image-arrived-3.png"
                        alt=""
                        class="w-full h-full object-cover object-center"
                    />
                    </div>
                ...
                <div class="px-4 relative card group">
                    ...
                    <img
                        src="../assets/images/content/image-arrived-4.png"
                        alt=""
                        class="w-full h-full object-cover object-center"
                    />
                    </div>
                ...
                <div class="px-4 relative card group">
                    ...
                    <img
                        src="../assets/images/content/image-arrived-5.png"
                        alt=""
                        class="w-full h-full object-cover object-center"
                    />
                    </div>
            ...
            <div class="flex justify-center flex-wrap">
                ...
                >
                <img src="../assets/images/content/logo-adobe.svg" alt="" class="mx-auto" />
                </div>
                <div
                class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0"
                >
                <img src="../assets/images/content/logo-ikea.svg" alt="" class="mx-auto" />
                </div>
                <div
                class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0"
                >
                ...
                class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0"
                >
                <img src="../assets/images/content/logo-miele.svg" alt="" class="mx-auto" />
                </div>
            </div>
            </section>
